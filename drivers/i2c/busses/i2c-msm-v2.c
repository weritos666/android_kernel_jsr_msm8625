 ...
 */
static int __devinit i2c_msm_qup_rsrcs_init(struct platform_device *pdev,
						struct i2c_msm_ctrl *ctrl)
{
	struct i2c_msm_xfer_mode_bam *bam = i2c_msm_bam_get_struct(ctrl);
...
static int __devinit i2c_msm_dt_to_pdata_populate(struct i2c_msm_ctrl *ctrl,
 ...
 */
static int __devinit i2c_msm_rsrcs_dt_to_pdata(struct i2c_msm_ctrl *ctrl,
					struct platform_device *pdev,
					struct i2c_msm_v2_platform_data **pdata)
{
	int ret = 0;
 ...
 * @return zero on success or negative error code
 */
static int __devinit i2c_msm_rsrcs_mem_init(struct platform_device *pdev,
						struct i2c_msm_ctrl *ctrl)
{
 ...
 * @return zero on success or negative error code
 */
static int __devinit i2c_msm_rsrcs_irq_init(struct platform_device *pdev,
						struct i2c_msm_ctrl *ctrl)
{
	int ret, irq;
 ...
 */
static void __devinit i2c_msm_rsrcs_gpio_init(struct i2c_msm_ctrl *ctrl)
{
	int i;
	/* invalidate all */
 ...
 * @return zero on success or negative error code
 */
static int __devinit i2c_msm_rsrcs_clk_init(struct i2c_msm_ctrl *ctrl)
{
	int ret = 0;
...
static int __devinit i2c_msm_frmwrk_reg(struct platform_device *pdev,
						struct i2c_msm_ctrl *ctrl)
{
	int ret;
...
static int __devinit i2c_msm_probe(struct platform_device *pdev)
{
	struct i2c_msm_ctrl             *ctrl;
	struct i2c_msm_v2_platform_data *pdata;
	int ret = 0;
...
static int __devexit i2c_msm_remove(struct platform_device *pdev)
{
...
static struct platform_driver i2c_msm_driver = {
	.probe  = i2c_msm_probe,
	.remove = __devexit_p(i2c_msm_remove),
	.driver = {
		.name           = "i2c-msm-v2",
		.owner          = THIS_MODULE,
		.pm             = &i2c_msm_pm_ops,
...
static int __devinit i2c_msm_init(void)
{
	return platform_driver_register(&i2c_msm_driver);
}
arch_initcall(i2c_msm_init);

static void __devexit i2c_msm_exit(void)
{
